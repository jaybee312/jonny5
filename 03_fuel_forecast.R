...
gas_scenarios    <- generate_scenario_forecasts(final_gasoline, "gasoline_retail", best_gas_model)
diesel_scenarios <- generate_scenario_forecasts(final_diesel,   "diesel_retail",   best_diesel_model)
